...
export function authErrorMessage(err: unknown): string {
  ...
  switch (code) {
    ...
    case 'auth/sms-region-not-enabled':
      return "SMS sign-in isn't enabled for this phone number's region yet — this is a Firebase Console setting, not something you can fix here. Try email or Google sign-in instead.";
    default:

        ...
        {lines.map(({ product, quantity }) => (
          <div key={product.id} className="p-4 flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 border border-gray-200 rounded-lg p-1 bg-gray-50">
              <button onClick={() => updateQuantity(product.id, quantity - 1)} className="p-1 rounded-md hover:bg-white text-gray-600">
            ...
            <button onClick={() => removeItem(product.id)} className="p-2 text-gray-400 hover:text-rose-600">
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-5 flex flex-col gap-4">
        ...
        {profile ? (
          <button
            ...
            disabled={submitting}
            className="w-full py-3 rounded-xl bg-primary hover:bg-primary/90 text-white font-bold text-sm flex items-center justify-center gap-2 disabled:opacity-50"
          >
          ...
          <button
            ...
            className="w-full py-3 rounded-xl bg-gray-900 hover:bg-gray-800 text-white font-bold text-sm flex items-center justify-center gap-2"
          >
